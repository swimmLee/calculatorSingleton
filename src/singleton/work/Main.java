...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Bob weighs " + 295 + " pounds and is " + 70 + " inches tall with a BMI of " + EnumCalcTool.calcBMI(70, 295, MeasurementSystem.ENGLISH));
        System.out.println("Christy weighs " + 184 + " kilograms and is " + 1.7 + " meters tall with a BMI of " + EnumCalcTool.calcBMI(1.7, 184, MeasurementSystem.METRIC));
        System.out.println("Sue weighs " + 235 + " pounds and is " + 63 + " inches tall with a BMI of " + EnumCalcTool.calcBMI(63, 235, MeasurementSystem.ENGLISH));
        System.out.println("Ricky weighs " + 241 + " kilograms and is " + 2.1 + " meters tall with a BMI of " + EnumCalcTool.calcBMI(2.1, 241, MeasurementSystem.METRIC));
